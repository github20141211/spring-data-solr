...
public class ITestMappingSolrConverter extends AbstractITestWithEmbeddedSolrServer {
	...
	static class Book {
		...
		@Id String id;
		@Field("type_s") String type;
		@Field("title_t") String title;
		@Field("author_s") String author;
		@Field("cat_s") String category;
		@Field("pubyear_i") int publicationYear;
		@Field("publisher_s") String publisher;

		@Field(child = true) List<BookReview> reviews;
	}
	...
	static class BookReview {
		...
		String id;
		@Field("type_s") String type;
		@Field("review_dt") Date date;
		@Field("stars_i") int stars;
		@Field("author_s") String author;
		@Field("comment_t") String comment;
	}
